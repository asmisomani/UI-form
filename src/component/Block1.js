...
import mailchimp from "../img/mailchimp.png";
  ...
  return (
    <div>
      <div id="bg" style={{ backgroundColor: color }}>
        <div className="width container" id="block1">
          <div id="l">
            <p className="badge clr-light">Start today!</p>
            <h1 className="head">
          ...
          <div id="r">
            ...
            <div className="lower-card card">
              <div className="r1 pd-front">
                <div>
              ...
              <div className="pd-front">
                <label htmlFor="comp" className="placeholder">
              ...
              <button
                className="btn"
                style={{ backgroundColor: color, color: "white" ,WebkitMaskImage:"linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5))",borderColor:color}}
              >
                Download Now
              </button>
            </div>
      ...
      <div className="block2">
        <div className="svgs width">
          <div className="text-expanded">HERE'S WHERE YOU CAN FIND US</div>
          <div className="svg">
            <svg
              _ngcontent-ffx-c55=""
              id="Layer_1"
            ...
            >
              <title _ngcontent-ffx-c55="">google</title>
              <path
                _ngcontent-ffx-c55=""
            ...
            >
              <title _ngcontent-gfe-c55="">product-hunt</title>
              <g _ngcontent-gfe-c55="" id="Page-1">
                <g
                  _ngcontent-gfe-c55=""
                  id="product-hunt-logo-horizontal-orange"
                >
                  <path
                    _ngcontent-gfe-c55=""
            ...
            >
              <title _ngcontent-gfe-c55="">mailchimp</title>
              <path
                _ngcontent-gfe-c55=""
            ...
            >
              <title _ngcontent-gfe-c55="">instagram</title>
              <path
                _ngcontent-gfe-c55=""
            ...
            >
              <title _ngcontent-gfe-c55="">pinterest</title>
              <path
                _ngcontent-gfe-c55=""
            ...
            >
              <title _ngcontent-gfe-c55="">dribbble</title>
              <path
                _ngcontent-gfe-c55=""
      ...
      <div className="market">
        <div className="width">
          <p className="badge clr">Marketing</p>
          <h2 className="sec-head">A better way to capture leads</h2>
          <p className="sec-para">
            Design can go a long way when capturing leads on your website. This
            lead caputre landing page example can help you get started!
          </p>
          <div className="flex">
            <div className="card">
              ...
              <h5 className="card-head">Cultivate better customers</h5>
              <p className="card-para">
                Learn how lead generation fits into your inbound marketing
                strategy and easy ways that you can start generating leads for
                your company
              </p>
            </div>
            <div className="card">
              ...
              <h5 className="card-head">Reach sales goals</h5>
              <p className="card-para">
                Attract and convert prospects into paying customers on your
                website by implementing a new design into your lead generation
                strategy
              </p>
            </div>
            <div className="card">
              ...
              <h5 className="card-head">Use the right tools</h5>
              <p className="card-para">
                By adding forms, call to action buttons, and information boxes,
                this template has the right tools to capture new leads
              </p>
            </div>
            <div className="card">
              <span class="material-icons-outlined">
              ...
              <h5 className="card-head">Easy to customimze</h5>
              <p className="card-para">
                Take sections and components from this UI Kit to build multiple
                variations of a lead caputre page to test which one performs
                better!
              </p>
            </div>
          </div>
      ...
      <div className="last width">
        <div className="txt">
          <p className="blue">Ready to get started?</p>
          <p className="sec-para">Create your account now!</p>
        </div>
        <div className="btns">
      ...
      <hr />
      <>
        <button className="settings" onClick={toggleShow}>
          <MdSettings className="spin" />
        </button>
        <Offcanvas
          show={show}
          onHide={handleClose}
        ...
        >
          ...
          <Offcanvas.Body>
            <span className="sub-h mt-3">Try a pre-built swatch!</span>
            {array1.map((array) => {
              return (
                <Swatch
                  style={array.styles}
                  title={array.title}
                  color={array.styles.backgroundColor}
                  colorHandler={()=>{setColor(array.styles.backgroundColor)}}
                />
              );
            })}
            <br />
            <span className="sub-h mt-3">Or choose your own colors</span>
            {array2.map((array) => {
              return (
                <Swatch
                  style={array.styles}
                  title={array.title}
                  hash={array.hash}
                  colorStyle={array.styles.backgroundColor}
                  colorHandler={()=>{setColor(array.styles.backgroundColor)}}
                />
              );
            })}
            <span className="sub-h mt-3">Need ideas? Randomize!</span>
            <Swatch
